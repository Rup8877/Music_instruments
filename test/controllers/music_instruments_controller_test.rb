...
class MusicInstrumentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create music_instrument' do
    assert_difference('MusicInstrument.count') do
      post music_instruments_url,
           params: { music_instrument: { item_description: @music_instrument.item_description,
                                         item_tittle: @music_instrument.item_tittle, phone_number: @music_instrument.phone_number, price: @music_instrument.price, user_name: @music_instrument.user_name } }
    end
  ...
  test 'should update music_instrument' do
    patch music_instrument_url(@music_instrument),
          params: { music_instrument: { item_description: @music_instrument.item_description,
                                        item_tittle: @music_instrument.item_tittle, phone_number: @music_instrument.phone_number, price: @music_instrument.price, user_name: @music_instrument.user_name } }
