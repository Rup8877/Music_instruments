...
MusicCategory.create!(category: 'Tabla', parent_id: nil)
MusicCategory.create(category: 'Drum', parent_id: nil)
MusicCategory.create(category: 'Guitar', parent_id: nil)
MusicCategory.create(category: 'Keyboard', parent_id: nil)
